...
const Toast: React.FC<{ message: ToastMessage; onDismiss: () => void }> = ({ message, onDismiss }) => {
    ...
    return (
        <div className={`flex items-start p-4 rounded-2xl shadow-2xl bg-surface/80 backdrop-blur-md ${animationClass}`} role="alert">
            ...
            <button onClick={handleDismiss} className="ml-4 text-text-secondary hover:text-text">
